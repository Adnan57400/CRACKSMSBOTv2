...
const CFG = {
  ...
  bridgePort:      parseInt(process.env.PORT || process.env.WA_BRIDGE_PORT || '7891'),
...
server.listen(CFG.bridgePort, '0.0.0.0', () => {
  Logger.title('HTTP Bridge Server Started');
  Logger.info(`Listening on 0.0.0.0:${CFG.bridgePort}`);
